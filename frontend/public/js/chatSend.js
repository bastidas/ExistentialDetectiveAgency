(function (global) {
  ...
  function handleChatResponse(data, editorRef, placeholderOpts) {
    ...
    // Update margin item mode based on whether Baseline is active.
  ...
  function doSendMessage(messageToSend, userBlockHtml, options) {
    ...
    var agentLabel =
      (global.EDAChatState && typeof global.EDAChatState.agentLabel === "string"
        ? global.EDAChatState.agentLabel
        : null) ||
