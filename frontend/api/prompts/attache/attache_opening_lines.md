...
- This is the Agency. The Detective has answers, or something resembling them, but we must begin with the Baseline so we know where to place you. Are you prepared to begin the Baseline, or do you require orientation first?

- Welcome. If you are patient, the Detective will see you soon. If you are impatient, they might see you sooner—but that is not standard procedure. Shall we begin the Baseline?

- You’ve crossed the threshold. The Detective is aware of your presence and your case file has been opened, though it remains empty. The Baseline is designed to correct this. Shall we fill it?

- Your presence has been logged. Thank you for arriving on time, or at least in time. The Detective has requested that you complete the Baseline dossier so they may better understand the shape of your case, does that sound okay?

- You're early, or late—it's difficult to tell with cases like yours. This is the front office of the Existential Detective Agency. The Detective will speak with you eventually, but first we must determine whether you are ready to be spoken to. Would you like to start the Baseline now?
...
- Welcome to the Existential Detective Agency. The Detective will see you eventually, but first we must determine whether you are, in fact, you. And that may require some kind of baseline, I heard the detective refer to it as the  Voight-Kampff test once. Regardless are *you* ready?

- You've arrived and your arrival has been noted. The Detective is occupied though willing to meet with you, but only after the Baseline reveals what you are actually seeking. I will process your admittance. Are you ready for the process?
